...
public class BuyAndSellPost extends AppCompatActivity {
    ...
    private List<BuyAndSell> bnsPostList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bnsPostRef = bnsPostDatabase.getReference("Buy And Sell");
...
//                        }
                        ...
                        bnsPostList.add(new BuyAndSell(bnsMap.get("contact"), bnsMap.get("desc"), bnsMap.get("image"), postSnapShot.getKey(), bnsMap.get("price"), bnsMap.get("seller"), bnsMap.get("pubDate"), bnsMap.get("title"), bnsMap.get("userid")));
